...
function AutoEmailTab() {
  ...
  const handleTemplateFileChange = async (selectedFile) => {
    ...
    try {
      const res = await fetch("https://65.1.129.37/upload-templates", {
        method: "POST",
        body: formData,
      });
  ...
  const generateEmailContent = async () => {
    ...
    try {
      const res = await fetch("https://65.1.129.37/generate-content", {
        method: "POST",
        headers: {
  ...
  const clearEmailContent = async () => {
    if (window.confirm("Are you sure you want to clear all email content?")) {
      ...
      try {
        await fetch("https://65.1.129.37/update-content", {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
          },
  ...
  const updateEmailContent = async () => {
    try {
      const res = await fetch("https://65.1.129.37/update-content", {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
        },
  ...
  const getEmailContent = async () => {
    try {
      ...
      const res = await fetch("https://65.1.129.37/get-content");
      const data = await res.json();
  ...
  const handlePreview = async () => {
    ...
    try {
      const res = await fetch("https://65.1.129.37/preview", {
        method: "POST",
        body: formData,
      });
      const data = await res.json();
  ...
  const handleUpload = async () => {
    ...
    try {
      const res = await fetch("https://65.1.129.37/upload", {
        method: "POST",
        body: formData,
      });
  ...
  useEffect(() => {
    ...
    if (sending) {
      interval = setInterval(async () => {
        try {
          const res = await fetch("https://65.1.129.37/progress");
          const data = await res.json();
          setProgress(data);
